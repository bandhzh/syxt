...
function initials() {
    var SortList=$(".mui-media");
    var SortBox=$(".mui-table-view");
    SortList.sort(asc_sort).appendTo('.mui-table-view');//按首字母排序
    ...
    $.each(initials, function(index, value) {//添加首字母标签
    	SortBox.append('<div class="pad bghui num" id="'+ value +'"><b><big>' + value + '</big></b></div>');
    });
    if(num!=0){
    	SortBox.append('<div class="pad bghui num" id="default"><b><big>#</big></b></div>');
    }
